...
<div class="menu">
	...
	<div class="items-menu">
		...
		<a <?php selecionadoMenu('cadastrar-trabalho'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>cadastrar-trabalho">Cadastrar Trabalho</a>
		...
		<a <?php selecionadoMenu('listar-trabalho'); ?> href="<?php echo INCLUDE_PATH_PAINEL ?>listar-trabalho">Listar Trabalho</a>
...
<header>
	<div class="center">
		...
		<div class="loggout">
			<a <?php if(@$_GET['url'] == ''){ ?> style="background: #b71c1c;padding: 15px;" <?php } ?> href="<?php echo INCLUDE_PATH_PAINEL ?>"> <i class="fa fa-home"></i> <span>Página Inicial</span></a>
