			...
			if(isset($_POST['acao'])){
				...
				if($nome == ''){
					...
					if(Painel::imagemValida($imagem) == false){
						...
						$arr = ['nome'=>$nome,'descricao'=>$descricao,'imagem'=>$imagem,'order_id'=>'0','nome_tabela'=>'tb_site.produto'];
						Painel::insert($arr);
						Painel::alert('sucesso','O cadastro do produto foi realizado com sucesso!');
					}
				}
